<script>
  import StoryRoot from '$lib/components/Story/StoryRoot.svelte'
</script>
...
<StoryRoot 
  slug="elements/tabs/orientation" 
  title="Tab Orientation & Alignment" 
  description="Control tab positioning with below and align properties"
/>