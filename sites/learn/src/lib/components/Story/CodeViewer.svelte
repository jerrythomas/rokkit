...
<TabGroup options={files} {fields} bind:value={current}>
	<div
		class="border-neutral-floating bg-neutral-elevated flex items-center justify-between border-b px-4 py-2"
	>
		<span class="text-neutral-overlay text-sm font-medium">{current?.name}</span>
