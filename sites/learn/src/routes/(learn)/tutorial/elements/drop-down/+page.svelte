...
<svelte:head>
	<title>DropDown - Elements | Learn Rokkit</title>
	<meta
		name="description"
		content="Context menus and action lists"
	/>
</svelte:head>
...
<div class="flex min-h-96 items-center justify-center">
	<div class="text-center">
		...
		<h1 class="text-neutral-overlay mb-2 text-3xl font-bold">DropDown Component</h1>
		...
		<div class="border-neutral-subtle bg-neutral-base rounded-lg border p-6">
			<p class="text-neutral-elevated">
				This tutorial section is coming soon. The DropDown component documentation and interactive
