<script>
	// Placeholder for forms inputs tutorial
</script>

<svelte:head>
	<title>Input Components - Forms | Learn Rokkit</title>
	<meta name="description" content="Explore different input types and their properties in Rokkit forms" />
</svelte:head>
...
<div class="space-y-8">
	...
	<div class="rounded-lg border border-neutral-200 bg-neutral-50 p-8 text-center dark:border-neutral-700 dark:bg-neutral-800">
		...
		<p class="text-lg text-neutral-600 dark:text-neutral-400 mb-6">
			This tutorial section is currently being developed. It will cover input components,
			form fields, validation, and best practices for building robust form interfaces.
		</p>
		<div class="rounded-lg bg-white border border-neutral-200 p-6 dark:bg-neutral-900 dark:border-neutral-700">
			...
			<ul class="text-left space-y-2 text-neutral-700 dark:text-neutral-300">
				<li>• Basic input components and their usage</li>
				<li>• Field mapping and data binding</li>
				<li>• Input validation techniques</li>
				<li>• Custom input component creation</li>
