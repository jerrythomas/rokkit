...
<article data-article-root>
	...
	<section data-card-cta>
		...
		<p>
			Now that you understand how the Accordion component works, explore other data-driven
			components like Tables and Trees, or learn about form components.
		</p>
		<span>
