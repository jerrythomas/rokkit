...
<article data-article-root>
  ...
  <p>
    See <a href="/docs/composability/snippets">Snippets & Customization</a> for full reference and examples.
  </p>
</article>
```
...
<article data-article-root>
  ...
  <p>
    See <a href="/docs/accessibility/keyboard-navigation">Keyboard Navigation</a> for the full keybinding
    reference.
  </p>
</article>
```
...
<div class="flex flex-col gap-6 p-6">
  ...
  <Tabs
    ...
    fields={{ label: 'label', value: 'value', icon: 'icon' }}
  />
