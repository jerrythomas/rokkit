/**
 * Koan chat primitives — demo-local components for the AI/chat-first shell.
 * Promote to @rokkit/ui after the API stabilises against real consumers.
 */
...
export { who, configureWho } from './who.svelte'
