	...
	test: {
		...
		coverage: {
			...
			thresholds: {
				...
				'packages/actions/**/*.{js,ts}': { statements: 86, lines: 92 },
				'packages/app/**/*.{js,ts}': { statements: 96, lines: 100 },
				'packages/app/**/*.svelte': { statements: 96, lines: 96 },
				'packages/blocks/**/*.{js,ts}': { statements: 100, lines: 100 },
				'packages/blocks/**/*.svelte': { statements: 53, lines: 66 },
				...
				'packages/forms/**/*.svelte': { statements: 66, lines: 76 },
