...
export const add = yaml.load(fs.readFileSync('src/fixtures/list/add.yml'))
export const remove = yaml.load(fs.readFileSync('src/fixtures/list/remove.yml'))

export const modify = yaml.load(fs.readFileSync('src/fixtures/list/modify.yml'))
export const altKey = yaml.load(
	fs.readFileSync('src/fixtures/list/alt-key.yml')
)
export const sorting = yaml.load(fs.readFileSync('src/fixtures/list/sort.yml'))
