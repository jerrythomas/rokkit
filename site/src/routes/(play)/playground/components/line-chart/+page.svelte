<script>
	...
	// mpg: 234 rows — x=cyl (4,5,6,8), y=hwy, color=drv, stat=mean
	// shows how highway mpg drops as cylinders increase, per drive type
		...
		elements: [
			{
				scope: '#/xField',
				label: 'x',
				props: { options: ['cyl', 'class', 'manufacturer', 'year'] }
			},
			{
				scope: '#/yField',
				label: 'y',
